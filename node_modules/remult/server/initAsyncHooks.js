...
exports.AsyncLocalStorageBridgeToRemultAsyncLocalStorageCore = exports.StubRemultAsyncLocalStorageCore = exports.SequentialRemultAsyncLocalStorageCore = exports.AsyncLocalStorageBridgeToRemultAsyncLocalStorageCoreImpl = void 0;
...
var SequentialRemultAsyncLocalStorageCore = /** @class */ (function () {
    function SequentialRemultAsyncLocalStorageCore() {
        this.wasImplemented = 'yes';
        this.lastPromise = Promise.resolve(undefined);
    }
    SequentialRemultAsyncLocalStorageCore.prototype.run = function (store, callback) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var log, stack_1, y, nextPromise;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (false) {
                            ...
                            stack_1 = y.join('\n');
                            log = function (msg) {
                                console.log(msg, stack_1);
                            };
                        }
                        log('waiting on ');
                        nextPromise = this.lastPromise.then(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        ...
                        this.lastPromise = nextPromise.catch(function () {
                            log('Error on ');
                            return undefined;
                        });
                        _a.label = 1;
    ...
    SequentialRemultAsyncLocalStorageCore.prototype.getStore = function () {
        return this.currentValue;
    };
    return SequentialRemultAsyncLocalStorageCore;
}());
exports.SequentialRemultAsyncLocalStorageCore = SequentialRemultAsyncLocalStorageCore;

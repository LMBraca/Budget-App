...
export declare class RepositoryImplementation<entityType> implements Repository<entityType>, RepositoryInternal<entityType> {
    ...
    _rawFind(options: FindOptions<entityType> | undefined, skipOrderByAndLimit: boolean | undefined, loader: RelationLoader): Promise<entityType[]>;
...
declare abstract class rowHelperBase<T> {
    ...
    buildErrorInfoObject(): ErrorInfo<unknown>;
    ...
    validate(): Promise<ErrorInfo<unknown> | undefined>;
...
export declare class rowHelperImplementation<T> extends rowHelperBase<T> implements EntityRef<T> {
    ...
    private edp;
    private _isNew;
    constructor(info: EntityFullInfo<T>, instance: T, repo: RepositoryImplementation<T>, edp: EntityDataProvider, remult: Remult, _isNew: boolean);

...
var RepositoryImplementation = /** @class */ (function () {
    ...
    RepositoryImplementation.prototype.insert = function (entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var refs_1, raw, entity_1, entity_1_1, item, ref, _a, _b, e_4_1, _c, r, entity_2, entity_2_1, item, _d, _e, e_5_1, ref;
            var e_4, _f, e_5, _g;
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                    ...
                    case 10:
                        try {
                            if (entity_1_1 && !entity_1_1.done && (_f = entity_1.return)) _f.call(entity_1);
                        }
                        finally { if (e_4) throw e_4.error; }
                        return [7 /*endfinally*/];
                    case 11:
                        _c = promiseAll;
                        return [4 /*yield*/, this._edp.insertMany(raw)];
                    case 12: return [2 /*return*/, _c.apply(void 0, [_h.sent(), function (item, i) { return refs_1[i].processInsertResponseDto(item); }])];
                    case 13:
                        r = [];
                        _h.label = 14;
                    case 14:
                    ...
                    case 20:
                        try {
                            if (entity_2_1 && !entity_2_1.done && (_g = entity_2.return)) _g.call(entity_2);
                        }
                        finally { if (e_5) throw e_5.error; }
                        return [7 /*endfinally*/];
                    case 21: return [2 /*return*/, r];
                    ...
                    case 25: return [4 /*yield*/, this.getEntityRef(this.create(entity)).save()];
    ...
    RepositoryImplementation.prototype.validate = function (entity) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var ref, hasError, fields_1, fields_1_1, f, e_6_1;
            var e_6, _a;
    ...
    RepositoryImplementation.prototype.updateMany = function (_a) {
        return tslib_1.__awaiter(this, arguments, void 0, function (_b) {
            var _c, _d, updated, _e, _f, _g, item, e_7_1;
            var _h, e_7, _j, _k;
            ...
            return tslib_1.__generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        ...
                        if (!this._dataProvider.isProxy) return [3 /*break*/, 2];
                        _d = (_c = this._edp).updateMany;
                        return [4 /*yield*/, this._translateWhereToFilter(where)];
                    case 1: return [2 /*return*/, _d.apply(_c, [_l.sent(), set])];
                    case 2:
                        updated = 0;
                        _l.label = 3;
                    case 3:
                        _l.trys.push([3, 9, 10, 15]);
                        _e = true, _f = tslib_1.__asyncValues(this.query({ where: where }));
                        _l.label = 4;
                    case 4: return [4 /*yield*/, _f.next()];
                    case 5:
                        if (!(_g = _l.sent(), _h = _g.done, !_h)) return [3 /*break*/, 8];
                        _k = _g.value;
                        _e = false;
                        item = _k;
                        (0, assign_js_1.assign)(item, set);
                        return [4 /*yield*/, (0, getEntityRef_js_1.getEntityRef)(item).save()];
                    case 6:
                        _l.sent();
                        updated++;
                        _l.label = 7;
                    ...
                    case 10:
                        ...
                        if (!(!_e && !_h && (_j = _f.return))) return [3 /*break*/, 12];
                    ...
                    case 15: return [2 /*return*/, updated];
                }
            });
        });
    };
    ...
    RepositoryImplementation.prototype._rawFind = function (options_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function (options, skipOrderByAndLimit, loader) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._edp.find(opt)];
                    case 2:
                        rawRows = _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._rawFind(options, skipOrderByAndLimit, loader)];
                    case 1:
                        result = _a.sent();
    ...
    RepositoryImplementation.prototype._loadManyToOneForManyRows = function (rawRows, loadOptions, loader) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            var loadFields, _a, _b, col, ei, isRelation, load, repo, toLoad, rawRows_1, rawRows_1_1, r, val, e_10_1, result, _loop_1, this_1, _c, _d, col;
            ...
            return tslib_1.__generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        toLoad = [];
                        try {
                            for (rawRows_1 = (e_11 = void 0, tslib_1.__values(rawRows)), rawRows_1_1 = rawRows_1.next(); !rawRows_1_1.done; rawRows_1_1 = rawRows_1.next()) {
                                r = rawRows_1_1.value;
                                val = r[col.key];
                                if (val !== undefined &&
                                    val !== null &&
                            ...
                            try {
                                if (rawRows_1_1 && !rawRows_1_1.done && (_f = rawRows_1.return)) _f.call(rawRows_1);
                            }
                    ...
                    case 7:
                        ...
                        return [7 /*endfinally*/];
                    case 8: return [4 /*yield*/, promiseAll(rawRows, function (r) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this._mapRawDataToResult(r, loadFields)];
                                case 1: return [2 /*return*/, _a.sent()];
                            }
                        }); }); })];
                    case 9:
                        ...
                        _loop_1 = function (col) {
                            ...
                            var incl = col.options
                                .defaultIncluded;
                            var include = (_h = loadOptions === null || loadOptions === void 0 ? void 0 : loadOptions.include) === null || _h === void 0 ? void 0 : _h[col.key];
                            ...
                            if (rel && incl) {
                                ...
                                var _loop_2 = function (row) {
                                    var _l = this_1._findOptionsBasedOnRelation(rel, col, incl, row, otherRepo), findOptions = _l.findOptions, returnNull = _l.returnNull;
                                    var colKey = col.key;
                                    if (returnNull)
                                        row[colKey] = null;
                                    else {
                                        ...
                                        loader
                                            ...
                                            find: function (options) { return toRepo_1._rawFind(options, false, loader); },
                                ...
                                try {
                                    for (var result_1 = (e_14 = void 0, tslib_1.__values(result)), result_1_1 = result_1.next(); !result_1_1.done; result_1_1 = result_1.next()) {
    ...
    RepositoryImplementation.prototype._findOptionsBasedOnRelation = function (rel, field, moreFindOptions, row, otherRepo) {
        ...
        try {
            for (var findOptionsSources_1 = tslib_1.__values(findOptionsSources), findOptionsSources_1_1 = findOptionsSources_1.next(); !findOptionsSources_1_1.done; findOptionsSources_1_1 = findOptionsSources_1.next()) {
                ...
                try {
                    for (var _e = (e_16 = void 0, tslib_1.__values([
                        'limit',
                        'include',
                        'orderBy',
    ...
    RepositoryImplementation.prototype._mapRawDataToResult = function (r, loadFields) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var x, helper;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        helper = new rowHelperImplementation(this._info, x, this, this._edp, this._remult, false);
    ...
    RepositoryImplementation.prototype.deleteMany = function (_a) {
        return tslib_1.__awaiter(this, arguments, void 0, function (_b) {
            var _c, _d, deleted, _e, _f, _g, item, e_18_1;
            var _h, e_18, _j, _k;
            var where = _b.where;
            return tslib_1.__generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._translateWhereToFilter(where)];
                    case 1: return [2 /*return*/, _d.apply(_c, [_l.sent()])];
                    case 2:
                        deleted = 0;
                        _l.label = 3;
                    case 3:
                    ...
                    for (_a = tslib_1.__values(this._fieldsOf(item)), _b = _a.next(); !_b.done; _b = _a.next()) {
                        ...
                        if (val !== null && val !== undefined) {
                            if (field.valueType === Date && !(val instanceof Date))
                                ...
                                try {
                                    for (_c = (e_21 = void 0, tslib_1.__values([
                                        [String, 'string'],
                                        [Number, 'number'],
                                        [Boolean, 'boolean'],
...
function createOldEntity(entity, remult) {
    ...
    var _loop_3 = function () {
        ...
        if (baseSettingsFactory) {
            ...
            try {
                for (var functions_1 = (e_22 = void 0, tslib_1.__values(functions)), functions_1_1 = functions_1.next(); !functions_1_1.done; functions_1_1 = functions_1.next()) {
            ...
            try {
                for (var _c = tslib_1.__values(this.fieldsMetadata), _d = _c.next(); !_d.done; _d = _c.next()) {
                    ...
                    if ((_b = this.errors) === null || _b === void 0 ? void 0 : _b[col.key]) {
                        error.message =
                            this.fields[col.key].metadata.caption +
                                ': ' +
                                this.errors[col.key];
...
var rowHelperImplementation = /** @class */ (function (_super) {
    ...
    function rowHelperImplementation(info, instance, repo, edp, remult, _isNew) {
        var e_30, _a;
    ...
    rowHelperImplementation.prototype.save = function (onlyTheseFieldsSentOnlyInTheCaseOfProxySaveWithPartialObject) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var doNotSave_1, e, _a, _b, col, e_32_1, d, ignoreKeys, _c, _d, field, f, updatedRow, isNew, _e, _f, changesOnly, wasChanged, key, element, _g, _h, _j, _k, listener, e_33_1, err_1;
            var e_32, _l, e_34, _m, _o, _p, e_33, _q;
            var _r, _s;
            return tslib_1.__generator(this, function (_t) {
                switch (_t.label) {
                    ...
                    case 13:
                        ...
                        if (!doNotSave_1) return [3 /*break*/, 16];
                        _f = (_e = this.edp).find;
                        _o = {};
                        return [4 /*yield*/, this.getIdFilter()];
                    ...
                    case 15:
                        ...
                        return [3 /*break*/, 18];
                    case 16: return [4 /*yield*/, this.edp.insert(d)];
                    case 17:
                        updatedRow = _t.sent();
                        _t.label = 18;
                    ...
                    case 19:
                        ...
                        if (!wasChanged)
                            return [2 /*return*/, this.instance];
                        if (!doNotSave_1) return [3 /*break*/, 22];
                        _h = (_g = this.edp).find;
                        _p = {};
                        return [4 /*yield*/, this.getIdFilter()];
                    ...
                    case 21:
                        ...
                        return [3 /*break*/, 24];
                    case 22: return [4 /*yield*/, this.edp.update(this.id, changesOnly)];
                    case 23:
                        updatedRow = _t.sent();
                        _t.label = 24;
                    case 24:
                        if (!updatedRow) return [3 /*break*/, 26];
                    ...
                    case 26:
                        e.id = this.getId();
                        if (!!this.repo._dataProvider.isProxy) return [3 /*break*/, 36];
                        if (!this.info.entityInfo.saved) return [3 /*break*/, 28];
                        return [4 /*yield*/, this.info.entityInfo.saved(this.instance, e)];
                    case 27:
                        _t.sent();
                        _t.label = 28;
                    case 28:
                        if (!this.repo.listeners) return [3 /*break*/, 36];
                        _t.label = 29;
                    case 29:
                        _t.trys.push([29, 34, 35, 36]);
                        _j = tslib_1.__values(this.repo.listeners), _k = _j.next();
                        _t.label = 30;
                    case 30:
                        if (!!_k.done) return [3 /*break*/, 33];
                        listener = _k.value;
                    ...
                    case 35:
                        ...
                        return [7 /*endfinally*/];
                    case 36: return [4 /*yield*/, this.repo._remult.liveQueryPublisher.itemChanged(this.repo.metadata.key, [{ id: this.getId(), oldId: this.getOriginalId(), deleted: false }])];
                    case 37:
                        _t.sent();
                        this.saveOriginalData();
                        this._isNew = false;
    ...
    rowHelperImplementation.prototype.buildDtoForInsert = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var d, ignoreKeys, _a, _b, field, f;
            var e_35, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
    ...
    rowHelperImplementation.prototype.delete = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var doDelete, e, _a, _b, listener, e_36_1, err_2;
            var e_36, _c;
            var _d;
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 14:
                        ...
                        return [7 /*endfinally*/];
                    case 15: return [4 /*yield*/, this.repo._remult.liveQueryPublisher.itemChanged(this.repo.metadata.key, [{ id: this.getId(), oldId: this.getOriginalId(), deleted: true }])];
                    case 16:
                        _e.sent();
    ...
    rowHelperImplementation.prototype.__performColumnAndEntityValidations = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, c, col, e_40_1, e, _c, _d, listener, e_41_1;
            var e_40, _e, e_41, _f;
            var _g;
            return tslib_1.__generator(this, function (_h) {
                switch (_h.label) {
...
var FieldRefImplementation = /** @class */ (function () {
    ...
    FieldRefImplementation.prototype.__performValidation = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var processValidation, self_1, event_1, _a, _b, v, _c, e_44_1, _d, error_1;
            var e_44, _e;
            var _this = this;
            var _f, _g;
            return tslib_1.__generator(this, function (_h) {
...
function buildCaption(caption, key, remult, metaData) {
    ...
    if (typeof caption === 'function') {
        ...
        result = caption;
    result = exports.CaptionTransformer.transformCaption(remult, key, result !== null && result !== void 0 ? result : '', metaData);
    if (result)
        return result;
    if (key)
